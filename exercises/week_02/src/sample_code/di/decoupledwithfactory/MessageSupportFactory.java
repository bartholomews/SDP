...
public class MessageSupportFactory {
	...
	private MessageSupportFactory() {
		...
		try {
			props.load(new FileInputStream("/Users/bartholomews/Projects/SDP/exercises/w02-SOLID_DI/sample_code/helloworld.di/src/decoupledwithfactory/bean.properties"));
